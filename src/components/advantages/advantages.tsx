export const Advantages = () => {
  const cards = [
    {
      ...
      text: "Bizning jamoamiz yuqori darajadagi xizmat va qo‘llab-quvvatlashni taqdim etishga tayyor tajribali mutaxassislardan iborat.",
      icon: (
        <svg
          stroke="currentColor"
          fill="currentColor"
    ...
    },
    {
      ...
      text: "Biz har doim sizning savollaringiz yoki takliflaringizga yordam berishga tayyormiz, 24/7 sifatli yordam taqdim etamiz.",
      icon: (
        <svg
          stroke="currentColor"
          fill="currentColor"
    ...
    {
      title: "Global tarmoq",
      text: "Bizning tarmog‘imiz ko‘plab mamlakatlarni qamrab oladi, bu bizga moslashuvchan va samarali yetkazib berish yechimlarini taqdim etish imkonini beradi.",
      icon: (
        <svg
          viewBox="0 0 496 512"
          fill="currentColor"
    ...
    },
    {
      ...
      text: "Tez va ishonchli yetkazib berish, tajribali jamoa va 24/7 qo‘llab-quvvatlash.",
      icon: (
        <svg
          stroke="currentColor"
          fill="currentColor"
  ...
  return (
    <section id="skills" className="w-full py-20 px-4 md:px-8 bg-white">
      ...
      <p className="sm:text-lg text-center text-gray-700 mb-10 max-w-3xl mx-auto">
        Biz zamonaviy texnologiyalar va sinovdan o‘tgan usullar yordamida
        sizning yuklaringizni ishonchli va xavfsiz yetkazib berishni
        kafolatlaymiz.
      </p>

      <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-4 gap-6 container1 mx-auto">
        {cards.map((card, idx) => (
          <div
            key={idx}
            className="group relative bg-gradient-to-br from-gray-200 to-gray-300 p-6 md:p-8 rounded-3xl shadow-xl transform hover:-translate-y-4 transition-all duration-700 overflow-hidden"
          >
